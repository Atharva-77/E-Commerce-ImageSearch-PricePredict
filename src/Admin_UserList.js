...
function Admin_UserList() {
  ...
  if (typeof users == "undefined") console.log("If Users:-", 0, users);
  else console.log("User len:-", Object.keys(users).length, users);
  ...
  const deleteUser = (id) => {
    ...
    if (window.confirm("Are you sure?")) {
      ...
      axios
        .delete(`${BASE_API_LINK}/login_brad/deleteUser/${id}`, config)
        .then((res) => {
