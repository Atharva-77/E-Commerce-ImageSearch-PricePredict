...
function ASeller_CreateProduct() {
  ...
  useEffect(() => {
    ...
    if ((imageURL != "" || url != "") && id_Img != 0) {
      ...
      axios
        .post(
          "https://e-commerce-imagesearch.vercel.app/extract_features",
          ImageSearchData
        )
        .then((res) => {
  ...
  useEffect(() => {
    ...
    if ((imageURL != "" || url != "") && id_Img != NaN) {
      ...
      axios
        .post(`${BASE_API_LINK}/imgFeature/add`, ImageFeatureData)
        .then((res) => {
  ...
  const price_predict = () => {
    ...
    axios
      .post(
        `https://ecommerce-priceprediction.herokuapp.com/predict_api`,
        predictPrice,
        config
      )
      .then((res) => {
  ...
  const submit_form = (e) => {
    ...
    axios
      .post(`/products/seller/products/add`, ProductData, config)
      .then((res) => {
    ...
    <div className="register">
      ...
      <div className="registration_details">
        ...
        <input
          value={Name}
          onChange={onName}
          placeholder="If user searches, it searches by this field"
        />
        ...
        {category == "Others" ? (
          ...
          <>
            ...
            <input
              ...
              placeholder="Enter Original Price for price prediction"
            />
            ...
            <button className="create_acc" onClick={price_predict}>
              Predict Price
            </button>
            <br />
          </>
        ...
        {Predictedprice != 0 ? (
          <p>Predicted price is:-{Predictedprice}</p>
        ) : null}
