...
function Admin_CreateProduct() {
  ...
  const uploadFileHandler = async (e) => {
    ...
    console.log(
      "FILE IS ADMIN Create",
      formData,
      formData.append("image", file)
    );
    //  axios.post("https://httpbin.org/anything",formData)
    axios
      .post(`${BASE_API_LINK}/uploadImg`, formData)
  ...
  const submit_form = () => {
    ...
    axios
      .post(`${BASE_API_LINK}/products/admin/products/add`, ProductData, config)
  ...
  return (
    <div className="register">
      ...
      <div className="registration_details">
        ...
        <button className="create_acc" onClick={submit_form}>
          Create Product
        </button>
