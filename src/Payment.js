...
function Payment() {
  ...
  // const redirect=`/`
  if (Object.keys(shippingAddr).length == 0) history.push("/shipping");
  // console.log("Ship if len:-",Object.keys(shippingAddr).length);
  else console.log("Ship else len:-", shippingAddr);
  ...
  const submit_form = () => {
    ...
    // axios.post(`${BASE_API_LINK}/register_brad/add`,userData)
    ...
    <div className="payment">
      ...
      <div className="registration_details">
        ...
        <p>
          ...
          <label for="paypal1" className="payment_label">
            PAYPAL
          </label>
          <br />
        </p>
