...
const ProductDetails = () => {
  ...
  const submit_form = () => {
    ...
    axios
      .post(`${BASE_API_LINK}/products/review/${id}`, ReviewData, config)
      .then((res) => {
        ...
        <div className="product_details_info">
          ...
          typeof product.imageURL != "undefined" ? (
            <img
              ...
              src={`${
                ...
                new Buffer.from(product.imageFile.data.data).toString("base64")
              }`}
            />
          ) : null}
          ...
          <p class="product_details_price">
            ...
            {product.countInStock > 0 ? (
              <button class="product_details_buy_button" onClick={addToBasket}>
                Add to Basket
              </button>
            ) : (
              <h2>Out of Stock</h2>
          ...
          <>
            ...
            {product.reviews.map((i) => (
              <>
                ...
                <p>
                  <strong>Posted At: </strong> {i.createdAt.substring(0, 10)}
                </p>
                <p>
                  <strong>Rating: </strong> {i.IndividualRating}
                </p>
                <p>
                  <strong>Comment: </strong> {i.comment}
                </p>
                <br />
              </>
            ))}
            ...
            <>
              {AlreadyReview ? (
                ...
                <>
                  ...
                  <br />
                  <button
                    class="product_details_review_submit"
                    onClick={submit_form}
                  >
                    Submit Review
                  </button>
