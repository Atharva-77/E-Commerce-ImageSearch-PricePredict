...
function Header() {
  ...
  let total_item = 0;
  {
    basketItems.map((item) => (total_item += item.qty));
  }
  ...
  useEffect(() => {
    ...
    //         axios.post("${BASE_API_LINK}/uploadImg/add3",Data)
    //         .then(
    //             res=>
    //             {
    //                 x=1;
    ...
    if (url != "") {
      ...
      axios
        .post(
          "https://e-commerce-imagesearch.vercel.app/image_search",
          ImageSearchData
        )
        .then((res) => {
          // x=0;
    ...
    <div className="header">
      ...
      <div className="header_search">
        ...
        <div className="dropImage">
          ...
          <CameraAlt
            className="header_searchIcon_Img"
            onChange={searchImgHandler}
          />
          <ArrowDropDownIcon
            className="arrow_iconCamera"
              ...
              {typeof file != "undefined" ? (
                <>
                  {imgSearchLoaderMessage ? (
                    ...
                    <p onClick={searchImgHandler} style={{ cursor: "pointer" }}>
                      Search
                    </p>
                  )}
                </>
